...
local torso = CHERETER:WaitForChild("Torso")
local torsoCF = torso.CFrame
local HEAD = CHERETER:WaitForChild("Head")
--ignore my messy code
--this literally took me around 20 minutes
function Random(num)
...
local messagetp = "Script fixed by _t38 on 09/10/2023"
print(messagetp)
